    ...
    <section className="relative overflow-hidden bg-background py-16 md:py-24 px-6 border-b border-border transition-colors duration-300">
      ...
      <div className="container mx-auto max-w-5xl relative z-10 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-foreground mb-6 tracking-tight leading-[1.1]">
          Find the <span className="text-emerald-600 dark:text-emerald-500">Service</span> or <br />
          <span className="text-blue-600 dark:text-blue-500 text-3xl md:text-5xl">Future Career</span> here.
        </h1>
        
        {/* Search Input Container */}
        <div className="relative group max-w-3xl mx-auto shadow-2xl dark:shadow-none overflow-hidden mt-10">
          ...
          <Button className="absolute right-2 top-2 h-12 rounded-xl px-8 bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-600 dark:hover:bg-emerald-500 text-white font-bold transition-all active:scale-95">
            Search
          </Button>
        </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-3 mt-10">
          <span className="text-muted-foreground text-sm font-semibold">Trending:</span>
          {["SaaS Dev", "Framer Motion", "Logo Design", "AI Specialist"].map((tag) => (
            <Badge 
              key={tag} 
              variant="outline" 
